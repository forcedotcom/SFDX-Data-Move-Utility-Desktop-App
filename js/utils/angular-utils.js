...
class AngularUtils {
    ...
    */
    static $apply($scope, callback, applyAlways = true) {
     ...
     */
    static $getController(elemSelector) {
        if (!elemSelector)
            return null;
     ...
     */
    static calculateHeightBetween(topElemSelector, bottomElemSelector, defaultHeight) {
     ...
     */
    static setScrollable(elemSelector, maxHeight, positionRelated = true, overflowXHidden = true) {
    ...
    */
    static async copyElementToClipboardAsync(elementSelector, copyValue = false) {
     ...
     * @returns A promise that resolves to true if the operation was successful, otherwise false.
     */
    static async copyTextToClipboardAsync(text) {
...
exports.AngularUtils = AngularUtils;
