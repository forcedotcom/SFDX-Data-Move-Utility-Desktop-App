...
exports.CONSTANTS = {
    ...
    LOGGER: {
         ...
         */
        UnhandledErrorMessagePattern: (message) => `ERROR!\n${message}`,
        /**
         * Pattern for formatting console log messages.
         * @param message - The log message.
         * @returns The formatted log message.
         */
        ConsoleLogMessagePattern: (message, messageType) => `LOG MESSAGE:${messageType.toUpperCase()}: ${message}`,
        /**
         ...
         * @returns The formatted log message.
         */
        FileLogMessagePattern: (functionName, lineNumber, message) => `[${functionName}:${lineNumber}] ${message}`,
        /**
        ...
        UnformattedFileLogMessagePattern: (functionName, lineNumber, message) => message,
    },
