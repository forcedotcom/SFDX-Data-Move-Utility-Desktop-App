...
angular.module('angucomplete', [])
  .directive('angucomplete', function ($parse, $http, $sce, $timeout) {
    return {
      ...
      template: `<div class="angucomplete-holder"><input id="{{id}}_value" ng-model="searchStr" type="text" placeholder="{{placeholder}}"
        class="{{inputClass}}" onmouseup="this.select();" ng-focus="resetHideResults()" ng-blur="hideResults()" />
    <div id="{{id}}_dropdown" class="angucomplete-dropdown" ng-if="showDropdown">
      ...
      link: function ($scope, elem, attrs) {
        ...
        $scope.inputChanged = function (evt) {
          if ($scope.changed) {
            $scope.changed({
              options: {
                $event: evt,
        ...
        inputField.on('change', $scope.inputChanged);

        attrs.$observe('defaultValue', function ($new) {
          $scope.searchStr = $new;
        ...
        attrs.$observe('disabled', function ($new) {
          if ($new == "true")
